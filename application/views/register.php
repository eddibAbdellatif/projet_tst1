              ...
              <div class="login-panel panel panel-success">
                  ...
                  if($error_msg){
                   ...
                   ?>
                      ...
                      <form role="form" action="<?php echo site_url('user/register_user/'); ?>"  method="post" >
                          <fieldset>
                              <div class="form-group">
                                  <input class="form-control" placeholder="Name" name="user_first_name" type="text" autofocus>
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Name" name="user_last_name" type="text" autofocus>
                              </div>
